...
public class SawmageddonAbility : Ability
{
    ...
    public override void Start()
    {
        ...
        time_left = PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.SawmageddonDuration, GameplayManager.Instance.Survival )
    ...
    {
        int num_extra_saws = PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.SawmageddonProjectiles, GameplayManager.Instance.Survival )
