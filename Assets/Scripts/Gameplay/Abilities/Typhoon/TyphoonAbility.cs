...
public class TyphoonAbility : Ability
{
    ...
    public override void Start()
    {
        ...
        if( PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.TyphoonRoaringFlames, GameplayManager.Instance.Survival )
            || PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.TyphoonExtendedBBQ, GameplayManager.Instance.Survival ) )
        {
    ...
    private void OnSawKilledEnemy( Vector3 enemy_position )
    {
        ...
        {
            if( PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.TyphoonRoaringFlames, GameplayManager.Instance.Survival ) && time_remaining >= 0.0f )
            {
