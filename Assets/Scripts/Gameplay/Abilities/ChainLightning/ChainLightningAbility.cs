...
public class ChainLightningAbility : Ability
{
    ...
    {
        Debug.Assert( PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.ChainLightningStaticOverload, GameplayManager.Instance.Survival ) ); // shouldn't be listening unless this was true
    ...
    {
        return PD.Instance.UpgradeUnlockMap.GetUnlock( PD.UnlockFlags.ChainLightningStunDuration, GameplayManager.Instance.Survival )
